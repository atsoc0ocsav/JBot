...
public class AquaticHibridNeuralNetworkController extends
	...
	public AquaticHibridNeuralNetworkController(Simulator simulator,
			Robot robot, Arguments args) {
		super(simulator, robot, args);

		passByWPController = new PassByWaypointsController(simulator, robot,
				args);
	}
